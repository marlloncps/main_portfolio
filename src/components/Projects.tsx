import fundacaomaster from "../../public/fundacaomaster.png";
import scoresales from "../../public/scoresales.png";

const projects = [
  {
    title: "Fundação Master",
    image: fundacaomaster,
    link: false,
    preview: "https://fundacaomaster.squareweb.app",
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <h3 className="text-4xl md:text-5xl font-medium mb-8">Projetos</h3>
        ...
        <a
          target="_blank"
          href="https://github.com/marlloncps?tab=repositories"
          aria-label="GitHub"
          className="w-full flex items-center justify-center gap-2 mt-9 text-[var(--white-icon)] hover:text-white transition duration-300 ease-in-out border border-[var(--white-icon-tr)] p-3 rounded-full bg-[#1414149c] hover:bg-[var(--white-icon-tr)]"
        >
          <span className="md:text-lg text-md">Mais projetos em</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
